...
/**
 * Helper class to map LWJGL 2 Keyboard constants to GLFW key codes
 */
public class GLFWKeyMapper {
    
    // LWJGL 2 Keyboard constants mapped to GLFW
    ...
    public static final int KEY_RMENU = GLFW_KEY_RIGHT_ALT;
